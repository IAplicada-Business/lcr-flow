...
function Dashboard() {
  // Semântica do dropdown: COMPETÊNCIA contábil direta (OPT-0004).
  // Default = competênciaAtual() (mês anterior ao calendário). Sem offset extra.
  ...
  // Cross product mês × ano → competências 1:1 (Jan/2026 → 2026-01).
  const competencias = (() => {
    const xs: string[] = [];
